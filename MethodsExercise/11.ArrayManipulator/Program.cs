...
namespace _11.ArrayManipulator
{
	class Program
	{
		...
		static int[] LastEvenOrOddElements(int[] arr, int neededCount, int divisibleResult)
		{
		 ...
		 static void Exchange(int[] arr, int position)
		{
		 ...
		 static int MaxEvenOrOddIndex(int[] arr, int divisonResult)
		{
		 ...
		 static int MinEvenOrOddIndex(int[] arr, int divisonResult)
		{
		...
		static int[] FirstEvenOrOddElements(int[] arr, int neededCount, int divisibleResult)
		{
			int[] resultArr = new int[neededCount];
			int currCounter = 0;
